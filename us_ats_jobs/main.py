"""
DEPRECATED: Single-Machine Scraper
----------------------------------
This script is legacy. For production scaling, use the Distributed Architecture:
1. Producer: python scripts/schedule_scraping.py
2. Worker:   python us_ats_jobs/worker_scraper.py
"""
import os
import pandas as pd
